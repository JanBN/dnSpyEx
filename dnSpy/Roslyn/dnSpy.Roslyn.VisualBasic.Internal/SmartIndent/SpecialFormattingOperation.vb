...
Namespace Global.dnSpy.Roslyn.VisualBasic.Internal.SmartIndent
	Friend Class SpecialFormattingRule
		...
		Private Shared Sub AddCaseClauseAlignTokensOperations(operations As List(Of AlignTokensOperation), node As SyntaxNode)
			...
			operations.Add(
				FormattingOperations.CreateAlignTokensOperation(
		...
		Private Overloads Shared Sub AddAlignTokensOperations (Of T As SyntaxNode)(operations As List(Of AlignTokensOperation),
		                                                                           node As SyntaxNode,
		                                                                           baseTokenGetter As Func(Of T, SyntaxToken))
